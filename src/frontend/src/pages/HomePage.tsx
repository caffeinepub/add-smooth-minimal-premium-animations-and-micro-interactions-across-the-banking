...
const features = [
  ...
  },
  {
    ...
    description:
      "Send money anywhere in India instantly with UPI, NEFT, RTGS, and IMPS — 24/7, 365 days.",
  ...
  },
  {
    ...
    description:
      "Personalized financial products tailored to your life stage — youth, family, senior, or rural.",
  ...
  },
  {
    ...
    description:
      "AI-powered investment recommendations, mutual funds, FDs, and wealth management tools.",
    color: "text-blue-700",
    bg: "bg-blue-50",
  },
];
    ...
    <main className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-lavender-50 via-white to-lavender-100 pt-16 pb-24">
        <div
          ...
          style={{
            backgroundImage:
              "url('/assets/generated/hero-orbs-bg.dim_1920x900.png')",
            ...
            <MotionReveal>
              <div className="space-y-6">
                ...
                <p className="text-lg text-[#1A1A1A] leading-relaxed max-w-lg font-medium">
                  Personalized financial solutions for every stage of life. From
                  your first job to retirement — DSOUZA Bank is your trusted
                  partner.
                </p>
            ...
            <MotionReveal delay={200}>
              <div className="relative">
                ...
                <div className="absolute -bottom-4 -left-4 glass rounded-xl px-4 py-3 shadow-soft-md">
                  ...
                  <p className="text-[10px] text-[#1A1A1A] font-medium">
                    Processed daily
                  </p>
                </div>
          ...
          <MotionReveal>
            <div className="text-center mb-12">
              ...
              <p className="text-[#1A1A1A] max-w-2xl mx-auto font-medium">
                ...
                deliver a banking experience that truly understands your needs.
              </p>
            </div>
          </MotionReveal>
      ...
      {/* Banking That Grows With You — Section Heading */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <MotionReveal>
            <h2 className="font-display text-4xl sm:text-5xl font-extrabold text-[#000000] tracking-tight leading-tight">
              Banking That Grows With You
            </h2>
            <div className="mt-4 mx-auto w-20 h-1 rounded-full bg-[#4B3FBC]" />
          </MotionReveal>
        </div>
      </section>
