...
> = {
  personal: [
    {
      ...
      description:
        "Earn up to 7% interest with our premium savings accounts. Zero minimum balance for digital accounts.",
      features: [
    ...
    },
    {
      ...
      title: "Credit Cards",
      description:
        "Premium credit cards with cashback, travel rewards, and exclusive lifestyle benefits.",
      features: [
        "Up to 5% cashback",
        "Airport lounge access",
        "Zero forex markup",
        "EMI on all purchases",
      ],
      color: "text-blue-700",
      bg: "bg-blue-50",
    },
    {
      ...
      description:
        "Secure your savings with guaranteed returns. Flexible tenures from 7 days to 10 years.",
      features: [
        "Up to 8.5% interest",
        "Flexible tenures",
        "Auto-renewal option",
  ...
  loans: [
    {
      ...
      title: "Home Loans",
      description:
        "Make your dream home a reality with competitive interest rates and flexible repayment options.",
      features: [
        "From 8.5% p.a.",
        "Up to ₹5 Cr loan",
        "30-year tenure",
    ...
    },
    {
      ...
      title: "Vehicle Loans",
      description:
        "Drive your dream car with easy financing. New and used vehicle loans available.",
      features: [
        "From 9% p.a.",
        "Up to 100% financing",
        "7-year tenure",
    ...
    },
    {
      ...
      description:
        "Instant personal loans for any need — medical, travel, education, or home renovation.",
      features: [
        "From 10.5% p.a.",
        "Up to ₹25 Lakh",
        "Instant disbursal",
  ...
  investments: [
    {
      ...
      title: "Mutual Funds",
      description:
        "Invest in curated mutual fund portfolios with AI-powered recommendations.",
      features: [
        "1000+ fund options",
        "SIP from ₹100",
        "Zero commission",
  ...
  insurance: [
    ...
    },
    {
      ...
      description:
        "Comprehensive coverage for health, vehicle, home, and travel.",
      features: [
        "Health insurance",
        "Motor insurance",
        "Home insurance",
  ...
  digital: [
    {
      ...
      description:
        "Full-featured banking app with AI assistant, voice banking, and smart analytics.",
      features: [
        "AI-powered insights",
        "Voice banking",
        "UPI payments",
    ...
    },
    {
      ...
      title: "Net Banking",
      description:
        "Comprehensive online banking portal with advanced features.",
      features: [
        "Fund transfers",
        "Bill payments",
        "Account statements",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <MotionReveal>
            ...
            <p className="text-lg text-[#1A1A1A] max-w-2xl mx-auto font-medium">
              From everyday banking to wealth management — discover financial
              products designed for every stage of your life.
            </p>
          </MotionReveal>
        </div>
      </section>
