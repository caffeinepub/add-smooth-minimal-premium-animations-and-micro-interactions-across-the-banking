...
function getCreditScore(value: number): {
  score: number;
  label: string;
  color: string;
} {
  if (value < 30)
    return {
      score: Math.round(580 + value * 2),
      label: "Fair",
      color: "text-red-500",
    };
  if (value < 60)
    return {
      score: Math.round(640 + value * 2),
      label: "Good",
      color: "text-amber-500",
    };
  if (value < 85)
    return {
      score: Math.round(720 + value * 1.5),
      label: "Very Good",
      color: "text-blue-500",
    };
  return {
    score: Math.round(780 + value * 0.8),
    label: "Excellent",
  ...
  return (
    <section
      className={`py-16 px-4 relative overflow-hidden ${
        isYouthMode
          ? "bg-gradient-to-br from-purple-50 via-ice-blue/30 to-amber-50"
          : "bg-white"
      }`}
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(/assets/generated/youth-dream-builder.dim_800x500.png)",
        }}
        aria-hidden="true"
      />
        ...
        <MotionReveal>
          <div className="text-center mb-12">
            ...
            <p className="text-[#000000] mt-6 max-w-xl mx-auto">
              Your financial journey starts here. Set goals, earn badges, and
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <MotionReveal delay={100}>
            <div className="glass-card rounded-2xl p-6">
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium text-deep-navy text-sm">
                            {goal.label}
                          </span>
                        </div>
                      ...
                      <div className="relative">
                        ...
                        <span className="absolute right-0 -top-5 text-xs font-semibold text-[#000000]">
                          {pct}%
                        </span>
                      </div>
                    </div>
              ...
              <button
                type="button"
                className="mt-5 w-full py-2 border-2 border-dashed border-gold/40 rounded-xl text-sm text-[#000000] hover:border-gold hover:text-deep-navy transition-all"
              >
                + Add New Goal
              </button>
            </div>
                ...
                {badges.map((badge) => (
                  ...
                  >
                    <div className="relative mb-1">
                      ...
                      {!badge.earned && (
                        <Lock className="w-3 h-3 text-[#000000] absolute -bottom-1 -right-1" />
                      )}
                    </div>
                    <span className="text-xs font-semibold text-deep-navy leading-tight">
                      {badge.label}
                    </span>
                    <span className="text-xs text-[#000000] mt-0.5">
                      {badge.desc}
                    </span>
                  </div>
                ))}
            ...
            <div className="glass-card-navy rounded-2xl p-6">
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <div className="text-white font-semibold">
                      {investmentSteps[investStep].title}
                    </div>
                    <div className="text-xs text-white font-medium">
                      Step {investStep + 1} of {investmentSteps.length}
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  onClick={() =>
                    setInvestStep(
                      Math.min(investmentSteps.length - 1, investStep + 1),
                    )
                  }
          ...
          <MotionReveal delay={250}>
            <div className="glass-card rounded-2xl p-6">
              ...
              <p className="text-sm text-[#000000] mb-6">
                Adjust your financial habits to see how they impact your credit
                score.
              </p>
              <div className="text-center mb-6">
                <div
                  className={`text-5xl font-bold font-display ${creditInfo.color} mb-1`}
                >
                  {creditInfo.score}
                </div>
                <div className={`text-sm font-semibold ${creditInfo.color}`}>
                  {creditInfo.label}
                </div>
