...
const insuranceProducts = [
  {
    ...
    bgColor: "bg-rose-50",
    explanation:
      "Health insurance covers your medical expenses — from doctor visits to surgeries. Pay a small premium monthly, and we cover your hospital bills up to your sum insured. No more worrying about medical emergencies draining your savings.",
    coverage: "₹5L – ₹50L",
  ...
  },
  {
    ...
    bgColor: "bg-blue-50",
    explanation:
      "Life insurance ensures your family is financially secure if something happens to you. A term plan gives your family a lump sum payout. It's the most affordable way to protect the people you love.",
    coverage: "₹25L – ₹2Cr",
  ...
  },
  {
    ...
    explanation:
      "Designed specifically for citizens above 60, our senior medical plans cover pre-existing conditions, regular health check-ups, and critical illness. No medical tests required for entry.",
    coverage: "₹3L – ₹20L",
  ...
  },
  {
    ...
    bgColor: "bg-green-50",
    explanation:
      "Micro insurance is designed for low-income families and daily wage workers. Pay as little as ₹50/month and get coverage for accidents, hospitalization, and life. Simple, affordable, and accessible.",
    coverage: "₹50K – ₹5L",
  ...
  },
  {
    ...
    bgColor: "bg-amber-50",
    explanation:
      "Crop insurance protects farmers from losses due to drought, floods, pests, or natural disasters. Linked to government schemes like PMFBY, it ensures you get compensated even when nature is unpredictable.",
...
const assessmentQuestions = [
  {
    id: "health",
    question: "Do you have health insurance covering ₹5L or more?",
    weight: 25,
  },
  {
    id: "life",
    question: "Do you have life insurance of at least 10x your annual income?",
    weight: 30,
  },
  {
    id: "emergency",
    question: "Do you have 3+ months of expenses saved as emergency fund?",
    weight: 25,
  },
  {
    id: "critical",
    question: "Do you have critical illness or disability coverage?",
    weight: 20,
  },
];
...
const claimSteps = [
  {
    step: 1,
    title: "Report Claim",
    desc: "Call our 24/7 helpline or use the app to register your claim instantly.",
    icon: "📞",
    duration: "2 min",
  },
  {
    ...
    desc: "Upload required documents — hospital bills, reports, or FIR — via app or branch.",
    icon: "📄",
    duration: "10 min",
  },
  {
    step: 3,
    title: "Verification",
    desc: "Our team verifies your claim within 24 hours using AI-assisted processing.",
    icon: "🔍",
    duration: "24 hrs",
  },
  {
    step: 4,
    title: "Settlement",
    desc: "Approved claims are settled directly to your bank account within 3 working days.",
    icon: "💰",
    duration: "3 days",
  },
];
...
export default function ProtectionSecurityHub() {
  ...
  const answeredAll = assessmentQuestions.every(
        ...
        <MotionReveal>
          <div className="text-center mb-12">
            ...
            <p className="text-[#000000] mt-6 max-w-xl mx-auto">
              Complete insurance solutions designed for every life stage —
              simple, affordable, and trustworthy.
            </p>
          </div>
        </MotionReveal>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
            {insuranceProducts.map((product) => (
              <button
                type="button"
                key={product.id}
                className="glass-card rounded-2xl overflow-hidden cursor-pointer w-full text-left"
              ...
              >
                <div className="p-5">
                  <div className="flex items-start justify-between mb-3">
                    <div
                      className={`p-2.5 rounded-xl ${product.bgColor} ${product.color}`}
                    >
                      {product.icon}
                    </div>
                  ...
                  <h3 className="font-display font-semibold text-deep-navy mb-1">
                    {product.title}
                  </h3>
                  ...
                  <div className="flex items-center gap-3 text-xs">
                    ...
                    <span className="text-[#000000]">{product.premium}</span>
                  </div>
                </div>
                ...
                {expandedCard === product.id && (
                  <div className={"px-5 pb-5 pt-0 border-t border-gold/10"}>
                    <div className={`${product.bgColor} rounded-xl p-4 mt-3`}>
                      ...
                      <button
                        type="button"
                        className="mt-3 text-sm font-semibold text-deep-navy flex items-center gap-1 hover:gap-2 transition-all"
                      >
              ...
              {answeredAll && (
                <div className="mt-4">
                  {!showResult ? (
                    ...
                    <div
                      className={`flex items-center gap-3 p-4 rounded-xl ${resultBadge.color}`}
                    >
                      {resultBadge.icon}
                      <div>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <span
                          className={`text-sm font-semibold ${i <= activeClaimStep ? "text-white" : "text-white/80"}`}
                        >
                          {step.title}
                        </span>
                        <span
                          className={`text-xs ${i <= activeClaimStep ? "text-gold" : "text-white/70"}`}
                        >
                          {step.duration}
                        </span>
                      </div>
                      <p
                        className={`text-xs mt-0.5 ${i <= activeClaimStep ? "text-white" : "text-white/70"}`}
                      >
                        {step.desc}
                      </p>
                    </div>
