    ...
    <section className="py-20 px-4 bg-deep-navy relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center">
        <MotionReveal>
          ...
          <p className="text-lg md:text-xl text-white leading-relaxed max-w-3xl mx-auto mb-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button
              type="button"
              className="px-8 py-3.5 rounded-full text-base font-semibold text-white border-2 border-white/20 hover:border-gold/50 hover:text-gold transition-all"
            >
              Learn More About Us
            </button>
          </div>
