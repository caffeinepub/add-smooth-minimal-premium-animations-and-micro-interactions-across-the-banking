  ...
  return (
    <div className="glass-card rounded-2xl p-5 h-full">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-display font-semibold text-deep-navy">
          Home Loan Tracker
        </h3>
      </div>
      <div className="space-y-3">
        <div className="bg-ice-blue/60 rounded-xl p-3">
          <div className="text-xs text-[#000000] mb-1">Outstanding Balance</div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-sage-green/50 rounded-xl p-3">
            <div className="text-xs text-[#000000] mb-1">Monthly EMI</div>
            <div className="text-lg font-bold text-deep-navy">₹24,500</div>
          </div>
          <div className="bg-gold/10 rounded-xl p-3">
            <div className="text-xs text-[#000000] mb-1">Remaining</div>
            <div className="text-lg font-bold text-deep-navy">14 yrs</div>
          </div>
        </div>
        <div>
          <div className="flex justify-between text-xs text-[#000000] mb-1">
            <span>Repaid</span>
            <span>38%</span>
          </div>
          <Progress value={38} className="h-2" />
        </div>
        <div className="text-xs text-[#000000] bg-amber-50 rounded-lg p-2">
...
function EducationCalculator() {
  ...
  const monthlyNeeded =
    yearsLeft > 0 ? Math.round((targetAmount[0] / (yearsLeft * 12)) * 1.08) : 0;
      ...
      <div className="space-y-4">
        <div>
          <div className="flex justify-between text-sm mb-2">
            <span className="text-[#000000]">Child's Age</span>
        ...
        <div>
          <div className="flex justify-between text-sm mb-2">
            <span className="text-[#000000]">Target Amount</span>
            <span className="font-semibold text-deep-navy">
              ₹{(targetAmount[0] / 100000).toFixed(1)}L
            </span>
          </div>
          <Slider
            value={targetAmount}
            ...
            max={5000000}
            step={100000}
            aria-label="Target education amount"
          />
        </div>
          ...
          <div key={inst.name}>
            <div className="flex justify-between text-sm mb-1">
              ...
              <span className="text-[#000000]">
                ₹{(inst.invested / 1000).toFixed(0)}K / ₹
                {(inst.limit / 1000).toFixed(0)}K
              </span>
            </div>
          ...
          return (
            <div key={cov.label}>
              <div className="flex justify-between text-sm mb-1.5">
                ...
                <span
                  className={`text-xs font-semibold ${pct >= 80 ? "text-green-600" : pct >= 40 ? "text-amber-600" : "text-red-600"}`}
                >
                  {pct}% covered
                </span>
              </div>
  ...
  return (
    <section className="py-16 px-4 bg-gradient-to-br from-white to-ice-blue/20 relative overflow-hidden">
      <div
        ...
        style={{
          backgroundImage:
            "url(/assets/generated/family-planner-hero.dim_800x500.png)",
        }}
        aria-hidden="true"
      />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <MotionReveal>
          <div className="text-center mb-12">
            ...
            <p className="text-xl font-display text-[#000000] mt-6 mb-2">
              Secures Tomorrow.
            </p>
            <p className="text-[#000000] max-w-xl mx-auto">
              Comprehensive financial planning tools designed for every family
              milestone.
            </p>
          </div>
        </MotionReveal>
