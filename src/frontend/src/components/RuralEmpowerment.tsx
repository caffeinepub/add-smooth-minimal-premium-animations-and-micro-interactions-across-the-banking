  ...
  return (
    <section
      className={`py-16 px-4 relative overflow-hidden ${
        isRuralMode
          ? "bg-sage-green/40"
          : "bg-gradient-to-br from-sage-green/30 to-ice-blue/20"
      }`}
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <MotionReveal>
          <div className="text-center mb-12">
            ...
            <p className="text-[#000000] max-w-xl mx-auto">
              We believe banking should reach every corner of India — from
        ...
        <div
          className={`grid gap-4 ${isRuralMode ? "grid-cols-1" : "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3"}`}
        >
            ...
            <MotionReveal key={feature.title} delay={i * 80}>
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`p-3 rounded-xl ${feature.bgColor} ${feature.color} flex-shrink-0`}
                  >
                    {feature.icon}
                  </div>
                  <div className="flex-1">
                    <h3 className="font-display font-semibold text-deep-navy mb-1.5">
                      {feature.title}
                    </h3>
                    <p className="text-sm text-[#000000] leading-relaxed mb-3">
                      {feature.desc}
                    </p>
                    <button
                      type="button"
            ...
            <div className="inline-flex items-center gap-3 bg-deep-navy text-white px-6 py-3 rounded-2xl">
              ...
              <div className="text-left">
                <div className="text-sm font-semibold">
                  Rural Banking Helpline
                </div>
                <div className="text-xs text-white font-medium">
                  1800-XXX-XXXX (Toll Free) | Available in 10 languages
                </div>
              </div>
            </div>
          </div>
