...
export default function VoiceAssistant({ className = '' }: VoiceAssistantProps) {
  ...
  const handleVoiceCommand = (command: string) => {
    ...
    if (lowerCommand.includes('about') && (lowerCommand.includes('dsouza') || lowerCommand.includes('bank'))) {
      response =
    ...
    } else if (lowerCommand.includes('life') && (lowerCommand.includes('based') || lowerCommand.includes('stage'))) {
      response =
    ...
    } else if (lowerCommand.includes('first job') || lowerCommand.includes('career')) {
      response =
    ...
    } else if (lowerCommand.includes('family') || lowerCommand.includes('planning')) {
      response =
    ...
    } else if (lowerCommand.includes('retirement') || lowerCommand.includes('retire')) {
      response =
    ...
    } else if (lowerCommand.includes('service') || lowerCommand.includes('offer')) {
      response =
    ...
    } else if (lowerCommand.includes('contact') || lowerCommand.includes('reach')) {
      response =
