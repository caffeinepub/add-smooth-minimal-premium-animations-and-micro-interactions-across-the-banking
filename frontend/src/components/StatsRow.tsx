...
const stats = [
  { icon: Users, value: 15, suffix: "M+", label: "Happy Customers", color: "text-lavender-700" },
  { icon: Building2, value: 850, suffix: "+", label: "Branches Nationwide", color: "text-blue-700" },
  { icon: Award, value: 40, suffix: "+", label: "Years of Trust", color: "text-emerald-700" },
  { icon: TrendingUp, value: 98, suffix: "%", label: "Customer Satisfaction", color: "text-amber-700" },
];
