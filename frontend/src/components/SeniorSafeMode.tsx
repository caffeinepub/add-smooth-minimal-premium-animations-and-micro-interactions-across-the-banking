...
import { Heart, Volume2, PiggyBank, AlertOctagon, Type, CheckCircle } from 'lucide-react';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundImage: 'url(/assets/generated/senior-safe-mode.dim_800x500.png)' }}
        aria-hidden="true"
      />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <MotionReveal>
          <div className="text-center mb-12">
            ...
            <p className="text-deep-navy/60 mt-6 max-w-xl mx-auto text-lg">
              Banking designed with care for our senior citizens — large text, easy navigation, and
              complete security.
            </p>
          </div>
        </MotionReveal>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              <div className="space-y-5">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    <Label htmlFor="large-font" className="text-base font-medium text-deep-navy">
                      Large Font
                    </Label>
                    <p className="text-sm text-deep-navy/60">Increase text size for easier reading</p>
                  </div>
                  <Switch
                    id="large-font"
                    checked={fontSize === 'large'}
                    onCheckedChange={(checked) => setFontSize(checked ? 'large' : 'medium')}
                    aria-label="Toggle large font size"
                  />
                </div>
                <div className="flex items-center justify-between gap-3">
                  <div>
                    <Label htmlFor="high-contrast" className="text-base font-medium text-deep-navy">
                      High Contrast
                    </Label>
              ...
              <div className="mt-4 p-3 bg-ice-blue/60 rounded-xl text-sm text-deep-navy/70">
                Current:{' '}
                <strong>
          ...
          <MotionReveal delay={150}>
            <div className="glass-card rounded-2xl p-6">
              ...
              <p className="text-deep-navy/65 text-base leading-relaxed mb-4">
                Navigate the entire app using your voice. Just say commands like:
              </p>
              <div className="space-y-2">
                {['"Check my balance"', '"Transfer money"', '"Pay bill"', '"Call support"'].map(
                  (cmd) => (
                    <div key={cmd} className="flex items-center gap-2 bg-purple-50 rounded-lg px-3 py-2">
                      <Volume2 className="w-3.5 h-3.5 text-purple-400 flex-shrink-0" />
                      <span className="text-sm font-medium text-purple-700">{cmd}</span>
                    </div>
                  )
                )}
              </div>
              <button className="mt-4 w-full btn-navy py-3 rounded-xl text-base font-semibold">
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              <div className="space-y-3">
                <div className="bg-deep-navy rounded-xl p-4 text-center">
                  <div className="text-xs text-white/60 mb-1">Total Pension Balance</div>
                  <div className="text-3xl font-bold font-display text-gold">₹12,45,000</div>
                </div>
                <div className="grid grid-cols-2 gap-2">
                  <div className="bg-sage-green/60 rounded-xl p-3 text-center">
                    <div className="text-xs text-deep-navy/60 mb-1">Monthly Payout</div>
                    <div className="text-xl font-bold text-deep-navy">₹18,500</div>
                  </div>
                  <div className="bg-ice-blue/60 rounded-xl p-3 text-center">
                    <div className="text-xs text-deep-navy/60 mb-1">Next Credit</div>
                    <div className="text-xl font-bold text-deep-navy">Mar 1</div>
                  </div>
                </div>
                <div className="text-sm text-deep-navy/60 bg-amber-50 rounded-lg p-2.5">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/65 text-base">
                      Instantly freeze all cards, disable UPI, and alert our security team with one
                      click.
                    </p>
                  </div>
                </div>
                {freezeSuccess ? (
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        <AlertDialogTitle>Freeze Your Account?</AlertDialogTitle>
                        <AlertDialogDescription>
                          This will immediately freeze all your cards, disable UPI transactions, and
                          alert our security team. You can unfreeze by calling our helpline.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
