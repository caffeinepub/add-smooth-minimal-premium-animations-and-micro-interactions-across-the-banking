...
const values = [
  {
    ...
    description: "We uphold the highest standards of transparency and ethical banking practices in every interaction.",
  ...
  },
  {
    ...
    description: "Every product, feature, and service is designed with our customers' best interests at heart.",
    color: "text-blue-700",
    bg: "bg-blue-50",
  },
  {
    icon: TrendingUp,
    title: "Innovation",
    description: "We continuously invest in technology to deliver cutting-edge banking solutions for modern India.",
  ...
  },
  {
    icon: Heart,
    title: "Inclusivity",
    description: "Banking for everyone — from rural communities to urban professionals, we serve all of India.",
    color: "text-red-700",
    bg: "bg-red-50",
  },
  {
    ...
    description: "Committed to green banking practices and supporting India's sustainable development goals.",
    color: "text-teal-700",
    bg: "bg-teal-50",
  },
  {
    icon: Award,
    title: "Excellence",
    description: "Award-winning service recognized by RBI, IBA, and leading financial institutions across India.",
...
const milestones = [
  { year: "1985", event: "Founded in Mumbai as a cooperative bank serving local communities." },
  { year: "1995", event: "Received scheduled commercial bank status from RBI." },
  { year: "2005", event: "Expanded to 500+ branches across 15 states." },
  { year: "2012", event: "Launched internet banking and mobile app — first in the region." },
  { year: "2018", event: "Crossed 10 million customers milestone." },
  { year: "2022", event: "Launched NEO digital banking platform with AI capabilities." },
  { year: "2024", event: "Introduced Life-Based Banking — personalized for every life stage." },
];
          ...
          <MotionReveal>
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-[#1A1A1A] leading-relaxed font-medium">
                Founded in 1985, DSOUZA Bank has grown from a small cooperative serving Mumbai's communities to one of India's most trusted financial institutions — serving over 15 million customers across 28 states.
              </p>
            </div>
          </MotionReveal>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <MotionReveal>
              <div className="p-8 bg-lavender-50 rounded-2xl border border-lavender-200/60">
                ...
                <h2 className="font-display text-2xl font-bold text-[#000000] mb-3">Our Mission</h2>
                <p className="text-[#1A1A1A] leading-relaxed font-medium">
                  To empower every Indian with accessible, affordable, and innovative financial services that enable them to achieve their dreams — regardless of their background, location, or life stage.
                </p>
              </div>
            </MotionReveal>
            ...
            <MotionReveal delay={150}>
              <div className="p-8 bg-gradient-to-br from-lavender-700 to-lavender-900 rounded-2xl text-white">
                ...
                <p className="text-lavender-100 leading-relaxed font-medium">
                  To be India's most trusted and innovative bank — a financial partner that grows with every customer through every stage of life, powered by technology and driven by human values.
                </p>
              </div>
            </MotionReveal>
          </div>
            ...
            {values.map((value, i) => (
              <MotionReveal key={value.title} delay={i * 80}>
                <div className="bg-white rounded-2xl p-6 border border-lavender-200/60 shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all duration-300">
                  ...
                  <h3 className="font-display font-bold text-lg text-[#000000] mb-2">{value.title}</h3>
                  <p className="text-sm text-[#1A1A1A] leading-relaxed font-medium">{value.description}</p>
                </div>
              </MotionReveal>
            ))}
          </div>
                ...
                <MotionReveal key={m.year} delay={i * 80}>
                  <div className="flex items-start gap-6 pl-4">
                    ...
                    <div className="flex-1 pb-2">
                      ...
                      <p className="text-sm text-[#1A1A1A] leading-relaxed font-medium">{m.event}</p>
                    </div>
                  </div>
                </MotionReveal>
              ))}
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-soft-xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-lavender-900/60 to-transparent flex items-end p-8">
                <div>
                  ...
                  <p className="text-lavender-200 text-sm font-medium">Mumbai, Maharashtra — Est. 1985</p>
                </div>
              </div>
            </div>
          </MotionReveal>
